...
exports.ColMetaDataPacket = (function() {

  __extends(ColMetaDataPacket, Packet);

  function ColMetaDataPacket() {
    ColMetaDataPacket.__super__.constructor.apply(this, arguments);
  }

  ColMetaDataPacket.type = 0x81;

  ColMetaDataPacket.name = 'COLMETADATA';

  ColMetaDataPacket.prototype.type = 0x81;

  ColMetaDataPacket.prototype.name = 'COLMETADATA';

  ColMetaDataPacket.prototype.columns = [];

  ColMetaDataPacket.prototype.fromBuffer = function(stream, context) {

var BufferBuilder, BufferStream, Login7Packet, LoginAckToken, Packet, PreLoginPacket, Socket, StreamIndexOutOfBoundsError, TdsConstants, TokenStreamPacket, _ref;
...
exports.TdsClient = (function() {
  ...
  TdsClient.prototype._handleToken = function() {
    var currentOffset, receivedLoginAck, token, _ref2, _ref3;
    token = null;
    ...
    while (true) {
      ...
      if ((_ref2 = this._handler) != null) {
        if (typeof _ref2.token === "function") _ref2.token(token);
      }

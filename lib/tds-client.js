var BufferBuilder, BufferStream, ColMetaDataToken, Login7Packet, LoginAckToken, Packet, PreLoginPacket, Socket, SqlBatchPacket, StreamIndexOutOfBoundsError, TdsConstants, TokenStreamPacket, _ref;
    ...
    while (true) {
      ...
      switch (token.type) {
        ...
        case ColMetaDataToken.type:
          ...
          this.columnsByName = token.columnsByName;
      }

...
exports.TdsClient = (function() {
  ...
  TdsClient.prototype._socketData = function(data) {
    var header, packet, _base, _base2, _base3, _base4, _base5, _base6;
    ...
    try {
      if (packet instanceof ColMetaDataPacket) {
        ...
        return typeof _handler.done === "function" ? _handler.done(packet) : void 0;
        ...
        return typeof (_base2 = this._handler).error === "function" ? _base2.error(packet) : void 0;
      } else if (packet instanceof InfoMessagePacket) {
        return typeof (_base3 = this._handler).info === "function" ? _base3.info(packet) : void 0;
      } else if (packet instanceof LoginAckPacket) {
        this.state = TdsConstants.statesByName['LOGGED IN'];
        return typeof (_base4 = this._handler).login === "function" ? _base4.login(packet) : void 0;
      } else if (packet instanceof PreLoginPacket) {
        this.state = TdsConstants.statesByName['CONNECTED'];
        return typeof (_base5 = this._handler).connect === "function" ? _base5.connect(packet) : void 0;
      } else if (packet instanceof RowPacket) {
        return typeof (_base6 = this._handler).row === "function" ? _base6.row(packet) : void 0;
      } else {

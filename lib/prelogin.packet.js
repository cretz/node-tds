...
exports.PreLoginPacket = (function() {
  ...
  PreLoginPacket.prototype.toBuffer = function(builder, context) {
    ...
    if ((_ref = this.version) == null) {
      this.version = [0x08, 0x00, 0x01, 0x55, 0x00, 0x00];
    }

var ColMetaDataToken, DoneToken, EnvChangeToken, ErrorMessageToken, InfoMessageToken, LoginAckToken, OrderByToken, Packet, ReturnStatusToken, RowToken,
...
OrderByToken = require('./orderby.token').OrderByToken;
...
exports.TokenStreamPacket = (function(_super) {
  ...
  TokenStreamPacket.prototype._getTokenFromType = function(type, context) {
    switch (type) {
  ...
  TokenStreamPacket.prototype.nextToken = function(stream, context) {
    ...
    token = this._getTokenFromType(type, context);
